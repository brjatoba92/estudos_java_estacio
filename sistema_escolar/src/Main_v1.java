...
public class Main {
    public static void main(String[] args) {
        ...
        // Carregar e exibir
        java.util.List<Escola> escolasCarregadas = JsonUtil.carregarLista("escola.json", Escola.class);
        if (escolasCarregadas != null && !escolasCarregadas.isEmpty()) {
            escolasCarregadas.get(0).listarAlunos();
        }
    }
}
